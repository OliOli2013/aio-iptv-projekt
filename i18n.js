...
(function () {
  ...
  const I18N = {
    pl: {
      cta_update_download: 'Aktualizacja <strong>AIO Panel v8.0 (Dual Python)</strong> — Pobierz teraz',
    ...
    en: {
      cta_update_download: 'Update: <strong>AIO Panel v8.0 (Dual Python)</strong> — Download now',
