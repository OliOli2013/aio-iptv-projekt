/* AIO-IPTV.pl PWA — community4 */
const CACHE='aio-iptv-pro-20260726-community4';
const CORE=[
  ...
  './assets/css/community.css?v=20260726-community4',
  './assets/js/user-premium.js?v=20260725-v15',
  './assets/js/community-core.js?v=20260726-community4',
  './assets/js/community-feed.js?v=20260726-community4',
  './assets/js/community-post.js?v=20260726-community4','./assets/js/community-profile.js?v=20260726-community4','./assets/js/community-admin.js?v=20260726-community4',
  './data/community_config.json?v=20260726-community4',
  './pliki/logo.png'
];
